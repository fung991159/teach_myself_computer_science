...
For example, projecting a complex number would involve throwing
...
;; >> paritally attempted this exercise, obviously the scope is very large
...
;; > no treally sur ehow to implement this
(define (drop-real x)
    (make-rational (cons (numerator x) (denominator x))))
