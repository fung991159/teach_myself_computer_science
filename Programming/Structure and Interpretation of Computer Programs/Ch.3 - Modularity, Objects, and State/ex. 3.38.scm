...
Concurrently, Peter deposits $10, Paul withdraws $20, and Mary withdraws half
...
assuming that the banking system forces the three processes to run sequentially
in some order.
...
>> see 3.38.png there are countless possible values since what balance value was retrieved
and set can affect each other, even in the compute new value stage