Exercise 3.44: Consider the problem of transferring an amount from one account
to another. Ben Bitdiddle claims that this can be accomplished with the
...
>> Louis is wrong. the essential difference is there is only 1 access to account
balance in transfer, while an additional access is required in "exchange" to
