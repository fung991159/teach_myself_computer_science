Exercise 3.11: In section 3.2.3 we saw how the environment model described the
...
>> local states of each balance (and the inner function) are kept within their own
env. Only "make-account" code is shared