...
>> this one is easy, changing assoc from hardcode testing "eq?"
to accepting a higher order func from make-table
...
(define (make-table same-key?)
  ...
  (define (assoc key records)
    (cond ((null? records) false)
          ((same-key? key (car (car records))) (car records)) ;todo: caar
...
(define operation-table (make-table #t))
